...
import { DropdownMenu, DropdownMenuContent, DropdownMenuRadioGroup, DropdownMenuRadioItem, DropdownMenuTrigger } from "@/components/ui/drop-down";
    ...
    return (
        <div className="relative z-10 flex w-full flex-col items-center justify-center px-4 py-5 sm:px-6 sm:pt-0 lg:px-8 sm:mt-24">
            <KartCard className="my-10 flex w-full max-w-lg flex-col items-start gap-y-8 p-8 drop-shadow-16 sm:mb-0">
                ...
                <p className="text-gray-300">Choose the token and amount you want to deposit as a reward.</p>
                    ...
                    <div className="w-full text-lg">
                        <div className="mt-2 flex items-center rounded-sm bg-transparent px-4 py-2 shadow-sm border border-purple-border">
                            <div className="relative flex grow items-stretch">
                                ...
                                <Input type="number" className="block w-full bg-transparent py-2 pl-20 outline-none placeholder:text-lg placeholder:text-primary/50 sm:text-lg sm:leading-6" />
                            </div>
                            <button
                                type="button"
                            ...
                            <SelectGroup>
                                {
                                    Array.from({ length: 36 }, (_, i) => (
                                        <SelectItem key={i + 1} className="text-gray-300" value={`${i + 1}`}>
                                            {i + 1} month{i + 1 > 1 ? 's' : ''}
                                        </SelectItem>
                                    ))
                                }
